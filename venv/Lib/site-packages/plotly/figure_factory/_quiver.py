...
class _Quiver(object):
    ...
    def get_barbs(self):
        ...
        barb_x = utils.flatten(list(zip(self.x, self.end_x, empty)))
        barb_y = utils.flatten(list(zip(self.y, self.end_y, empty)))
    ...
    def get_quiver_arrows(self):
        ...
        arrow_x = utils.flatten(list(zip(point1_x, self.end_x, point2_x, empty)))
        arrow_y = utils.flatten(list(zip(point1_y, self.end_y, point2_y, empty)))
