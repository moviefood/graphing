...
class HasTraits(six.with_metaclass(MetaHasTraits, HasDescriptors)):
    ...
    def __init__(self, *args, **kwargs):
        ...
        try:
            ...
            for k, v in list(super_kwargs.items()):
    ...
    def hold_trait_notifications(self):
        ...
        if self._cross_validation_lock:
            ...
            try:
                ...
                for name, changes in list(cache.items()):
                ...
                for changes in list(cache.values()):
    ...
    def add_traits(self, **traits):
        ...
        self.__class__ = type(self.__class__.__name__, (self.__class__,),
                              traits)
        for trait in list(traits.values()):
    ...
    def class_own_traits(cls, **metadata):
        ...
        """
        sup = super(cls, cls)
        return {n: t for (n, t) in list(cls.class_traits(**metadata).items())
    ...
    def class_own_trait_events(cls, name):
        ...
        """
        sup = super(cls, cls)
        return {n: e for (n, e) in list(cls.events(name).items())
...
class Dict(Instance):
    ...
    def class_init(self, cls, name):
        ...
        if self._traits is not None:
            for trait in list(self._traits.values()):
                trait.class_init(cls, None)
...
class UseEnum(TraitType):
    ...
    def select_by_number(self, value, default=Undefined):
        ...
        for enum_item in list(enum_members.values()):
    ...
    def info(self):
        ...
        result = "Any of: %s" % ", ".join(list(self.enum_class.__members__.keys()))
        if self.allow_none:
            return result + " or None"
        return result
