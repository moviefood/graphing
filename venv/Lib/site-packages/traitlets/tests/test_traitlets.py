...
def change_dict(*ordered_values):
    ...
    return dict(list(zip(change_names, ordered_values)))
...
class TestInt(TraitTestBase):
    ...
    _bad_values    = ['ten', 'ten', [10], {'ten': 10}, (10,), None, 1j,
                      ...
                      '-10L', '10.1', '-10.1',  '10', '-10', '10', -200]
    if not six.PY3:
        _bad_values.extend([int(10), int(-10), 10*sys.maxsize, -10*sys.maxsize])
...
class TestCInt(TraitTestBase):
    ...
    _default_value = 5
    _good_values   = ['10', '-10', '10', '-10', 10, 10.0, -10.0, 10.1]
    _bad_values    = ['ten', 'ten', [10], {'ten': 10},(10,),
                      None, 1j, '10.1', '10.1']
...
class LongTrait(HasTraits):
    ...
    value = Long(99 if six.PY3 else int(99))

class TestLong(TraitTestBase):

    obj = LongTrait()

    _default_value = 99 if six.PY3 else int(99)
    _good_values   = [10, -10]
    _bad_values    = ['ten', 'ten', [10], {'ten': 10},(10,),
    ...
    if not six.PY3:
        ...
        _good_values.extend([int(10), int(-10), 10*sys.maxsize, -10*sys.maxsize])
        _bad_values.extend([[int(10)], (int(10),)])
...
class MinBoundLongTrait(HasTraits):
    value = Long(99 if six.PY3 else int(99), min=5)
...
class MaxBoundLongTrait(HasTraits):
    value = Long(5 if six.PY3 else int(5), max=10)

class TestMaxBoundLong(TraitTestBase):
    obj = MaxBoundLongTrait()

    _default_value = 5 if six.PY3 else int(5)
    _good_values   = [10, -2]
    _bad_values    = [11, 20]
...
class TestCLong(TraitTestBase):
    ...
    def coerce(self, n):
        return int(n) if six.PY3 else int(n)
...
class TestCFloat(TraitTestBase):
    ...
    _default_value = 99.0
    _good_values   = [10, 10.0, 10.5, '10.0', '10', '-10', '10.0', '10']
    _bad_values    = ['ten', 'ten', [10], {'ten': 10}, (10,), None, 1j,
                      200.1, '200.1']
