...
class Application(SingletonConfigurable):
    ...
    def print_alias_help(self):
        ...
        for alias, longname in list(self.aliases.items()):
    ...
    def print_flag_help(self):
        ...
        lines = []
        for m, (cfg,help) in list(self.flags.items()):
    ...
    def print_subcommands(self):
        ...
        for p in wrap_paragraphs(self.subcommand_description.format(
            ...
            lines.append(p)
            lines.append('')
        for subc, (cls, help) in list(self.subcommands.items()):
            lines.append(subc)
            if help:
                lines.append(indent(dedent(help.strip())))
        lines.append('')
    ...
    def flatten_flags(self):
        ...
        # { 'alias' : 'Class.trait' }
        aliases = {}
        for alias, cls_trait in list(self.aliases.items()):
        ...
        flags = {}
        for key, (flagdict, help) in list(self.flags.items()):
            newflag = {}
            for cls, subdict in list(flagdict.items()):
                children = mro_tree[cls]
    ...
    def _classes_in_config_sample(self):
        ...
        while True:
            ...
            cls_to_config = OrderedDict( (cls, inc_yes or is_any_parent_included(cls))
                                  for cls, inc_yes
                                  in list(cls_to_config.items()))
            if cls_to_config == to_incl_orig:
                break
        for cl, inc_yes in list(cls_to_config.items()):
            if inc_yes:
                yield cl
