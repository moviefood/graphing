...
IUSERINFO_RE = '^(?:[' + IUNRESERVED_RE + SUB_DELIMITERS_RE + ':]|%s)+' % (
    PCT_ENCODED
)

IFRAGMENT_RE = ('^(?:[/?:@' + IUNRESERVED_RE + SUB_DELIMITERS_RE
                + ']|%s)*$' % PCT_ENCODED)
IQUERY_RE = ('^(?:[/?:@' + IUNRESERVED_RE + SUB_DELIMITERS_RE
             + IPRIVATE + ']|%s)*$' % PCT_ENCODED)
