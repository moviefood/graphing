...
def freeze(o):
    ...
    if typ is list:
        return pvector(list(map(freeze, o)))
    if typ is tuple:
...
def thaw(o):
    ...
    if isinstance(o, PMap):
        return dict((k, thaw(v)) for k, v in o.items())
...
def mutant(fn):
    ...
    def inner_f(*args, **kwargs):
        return freeze(fn(*[freeze(e) for e in args], **dict(freeze(item) for item in list(kwargs.items()))))
